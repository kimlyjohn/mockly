...
export const buildAiExamPrompt = (
  ...
  blocks.push(
    ...
    "CRITICAL: Do NOT wrap your response in markdown code blocks. DO NOT use ```json or ```.",
    "CRITICAL: Do not output any conversational text, preface, or postscript. Raw JSON only.",
    "",
    "OUTPUT CONTRACT (MUST FOLLOW)",
    "1. Output must be strict raw JSON only (NO code blocks).",
